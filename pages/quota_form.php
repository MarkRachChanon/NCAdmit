...
<!-- Header -->
<div class="bg-gradient-blue text-white py-4 mb-4 shadow">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="mb-0 opacity-75">ปีการศึกษา 2568</p>
            </div>
        ...
        <div class="card-body p-4">
            ...
            <div class="form-step active" data-step="1">
                ...
                <div class="d-flex justify-content-end mt-4">
                    <button type="button" class="btn btn-gradient btn-next px-5">
