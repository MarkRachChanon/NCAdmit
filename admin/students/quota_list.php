...
WHERE sq.academic_year = '$current_year'";

// เพิ่มเงื่อนไขการกรอง
if (!empty($status_filter)) {
    $sql .= " AND sq.status = '$status_filter'";
}

if ($department_filter > 0) {
    $sql .= " AND sq.department_id = $department_filter";
}

if (!empty($search)) {
    $sql .= " AND (sq.application_no LIKE '%$search%' 
              OR sq.firstname_th LIKE '%$search%' 
              OR sq.lastname_th LIKE '%$search%'
              OR sq.id_card LIKE '%$search%')";
}
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="index.php?page=export_excel&type=quota" class="btn btn-success">
                <i class="bi bi-file-earmark-excel me-2"></i>
                Export Excel
            </a>
            <a href="index.php?page=export_pdf&type=quota" class="btn btn-danger">
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="index.php?page=quota_list" class="btn btn-sm btn-outline-primary w-100 mt-3">
                        ดูทั้งหมด
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="index.php?page=quota_list&status=pending" class="btn btn-sm btn-outline-warning w-100 mt-3">
                        ตรวจสอบ
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="index.php?page=quota_list&status=approved" class="btn btn-sm btn-outline-success w-100 mt-3">
                        ดูรายชื่อ
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    ...
                    <a href="index.php?page=quota_list&status=rejected" class="btn btn-sm btn-outline-danger w-100 mt-3">
                        ดูรายชื่อ
                    </a>
                </div>
            </div>
        ...
        <div class="card-body">
            <form method="GET" action="index.php" class="row g-3">
                ...
                <div class="col-md-2 d-flex align-items-end">
                    ...
                    <a href="index.php?page=quota_list" class="btn btn-outline-secondary">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover data-table" id="quotaTable">
